...
# USAGE
# -----
#     # dry-run (no API calls, no writes) - default range: 2026-09-04 -> yesterday
...
# DUCK_PATH = _db_raw if os.path.isabs(_db_raw) else os.path.join(BASE_DIR, _db_raw)
# TABLE = "india_vix"
...
#     end = min(args.to_date, date.today() - timedelta(days=1))
